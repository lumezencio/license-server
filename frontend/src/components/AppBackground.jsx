...
export default function AppBackground({ children, patternOpacity = 0.10 }) {
  ...
  return (
    <div className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 min-h-screen w-full overflow-y-auto overflow-x-hidden">
      <div
